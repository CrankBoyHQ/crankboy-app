...
typedef struct ce_preference
{
    ...
    int (*get)(
        struct ce_preference* self
    ); /* returns index of current value (i.e. default value unless previously set) */
    void (*set)(
        struct ce_preference* self, unsigned value
    ); /* argument will be index of one of the values */
...
bool ce_start_rom(
    uint8_t* rom, size_t size, const char* system_directory, const char* rom_basename
);
