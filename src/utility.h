...
void draw_progress_ring(int x, int y, int radius, int line_width);
...
// (re)load localized strings; kPDLanguageSystem uses the system language
...
#define DEFER(BLOCK)                                              \
    void DEFER_FUNCNAME(__LINE__)(__attribute__((unused)) int* a) \
    {                                                             \
        BLOCK;                                                    \
    }                                                             \
