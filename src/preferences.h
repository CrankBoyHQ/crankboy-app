...
// A+B simultaneous
#define PREF_BUTTON_AB_NONE 0
#define PREF_BUTTON_AB_START 1
#define PREF_BUTTON_AB_SELECT 2
#define PREF_BUTTON_AB_START_SELECT 3

// as above, but suppress A/B input
#define PREF_BUTTON_N_START 4
#define PREF_BUTTON_N_SELECT 5
#define PREF_BUTTON_N_START_SELECT 6
