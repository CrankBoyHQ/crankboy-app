...
static void on_draw(gb_s* gb, ScriptData* data)
{
    ...
    if (show_sidebar)
    {
        ...
        if (refresh_lives)
        {
            ...
            draw_vram_tile_ext(
                ram_peek(0x9C2D), true, 2, lives_x + 16, lives_y + 16, gb->gb_reg.BGP, 0
            );
            draw_vram_tile_ext(
                ram_peek(0x9C0E), true, 2, lives_x + 8, lives_y + 32, gb->gb_reg.BGP, 0
            );
            draw_vram_tile_ext(
                ram_peek(0x9C2E), true, 2, lives_x + 8, lives_y + 48, gb->gb_reg.BGP, 0
            );
        ...
        if (refresh_hp)
        {
            ...
            {
                draw_vram_tile_ext(
                    ram_peek(0x9C07 + i), true, 2, hp_x, hp_y + (4 - i) * 16, gb->gb_reg.BGP,
                    DRAW_VRAM_TILE_FLAG_TRANSPOSE | DRAW_VRAM_TILE_FLAG_FLIPY
                );
                draw_vram_tile_ext(
                    ram_peek(0x9C27 + i), true, 2, hp_x + 16, hp_y + (4 - i) * 16, gb->gb_reg.BGP,
                    DRAW_VRAM_TILE_FLAG_TRANSPOSE | DRAW_VRAM_TILE_FLAG_FLIPY
                );
            }
        ...
        if (refresh_weapon_energy)
        {
            ...
            {
                draw_vram_tile_ext(
                    ram_peek(0x9C00 + i), true, 2, wp_x, wp_y + (4 - i) * 16, gb->gb_reg.BGP,
                    DRAW_VRAM_TILE_FLAG_TRANSPOSE | DRAW_VRAM_TILE_FLAG_FLIPY
                );
                draw_vram_tile_ext(
                    ram_peek(0x9C20 + i), true, 2, wp_x + 16, wp_y + (4 - i) * 16, gb->gb_reg.BGP,
                    DRAW_VRAM_TILE_FLAG_TRANSPOSE | DRAW_VRAM_TILE_FLAG_FLIPY
                );
            }
        ...
        if (refresh_boss_hp)
        {
            ...
            {
                draw_vram_tile_ext(
                    ram_peek(0x9C0F + i), true, 2, hp_x, hp_y + (4 - i) * 16, gb->gb_reg.BGP,
                    DRAW_VRAM_TILE_FLAG_TRANSPOSE | DRAW_VRAM_TILE_FLAG_FLIPY
                );
                draw_vram_tile_ext(
                    ram_peek(0x9C2F + i), true, 2, hp_x + 16, hp_y + (4 - i) * 16, gb->gb_reg.BGP,
                    DRAW_VRAM_TILE_FLAG_TRANSPOSE | DRAW_VRAM_TILE_FLAG_FLIPY
                );
            }
            playdate->graphics->markUpdatedRows(hp_y, hp_y + 16 * 5);
