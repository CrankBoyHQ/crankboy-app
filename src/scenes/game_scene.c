...
__section__(".rare") void tcm_relocate(bool cgb)
{
    ...
    if (core_on)
    {
        ...
        // the main pool (unless A is in it), else flash (offset 0, correct).
        void* b_reloc = NULL;
    ...
    if (draw_on)
    {
        ...
        if (!draw_reloc && !core_in_main_pool && !core_b_in_main_pool)
        {
